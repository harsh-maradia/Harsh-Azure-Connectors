...
class BitSightStatistics(BitSight):
    ...
    def get_diligence_historical_statistics_details(self, company_name, company_guid):
        ...
        try:
            ...
            checkpoint_data = self.checkpoint_obj.get_last_data(
                self.statistics_state, table_name=DILIGENCE_HISTORICAL_STATISTICS_TABLE
            )
    ...
    def get_graph_data(self, company_name, company_guid):
        ...
        try:
            ...
            last_date = None
            checkpoint_key = "{}".format(company_guid)
            checkpoint_data = self.checkpoint_obj.get_last_data(self.statistics_state, table_name=GRAPH_DATA_TABLE)
    ...
    def get_alerts_details(self, company_name, company_guid):
        ...
        try:
            data_to_post = None
            checkpoint_key = "{}".format(company_guid)
            checkpoint_data = self.checkpoint_obj.get_last_data(self.statistics_state, table_name=ALERTS_DATA_TABLE)
    ...
    def get_all_copmanies_alerts_graph_statistics_details(self, logs_data, company_names):
        ...
        fetching_index = self.get_last_data_index(
            ...
            self.checkpoint_obj,
            self.company_state,
            table_name="{}_{}".format(ALERTS_DATA_TABLE, "Statistics"),
        )
